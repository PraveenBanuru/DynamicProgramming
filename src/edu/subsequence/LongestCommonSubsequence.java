...
public class LongestCommonSubsequence {
	...
	static int lcsTopDown(String s1, String s2, int n, int m) {
		...
		System.out.println("Longest Common Subsequence is :" + printLCS(dp, s1, s2));

		System.out.println("Shortest Common Super sequence is :" + printSCS(dp, s1, s2));
		return dp[n][m];
	}

	static String printSCS(int[][] dp, String s1, String s2) {
		String output = "";
		int i = s1.length();
		int j = s2.length();
